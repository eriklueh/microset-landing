...
export const STRINGS = {
  es: {
    ...
    method: {
      ...
      titleL2: "repartida",
      titleL3: "en el día.",
      body: "microset toma tu rutina y la distribuye en pausas cortas a lo largo de tu jornada, respetando tu horario. El método y la intensidad los elegís vos; si te salteás una, reacomoda el resto del día.",
  ...
  en: {
    ...
    how: {
      ...
      steps: [
        ...
        { n: "02", t: "Build your routine", d: "Pick what to do per day type. Method and intensity are up to you." },
    ...
    method: {
      ...
      titleL3: "your day.",
      body: "microset takes your routine and distributes it into short breaks throughout your day, respecting your schedule. Method and intensity are your call; skip one and it reshuffles the rest of the day.",
